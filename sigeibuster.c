/* 
 * SigeiBuster - dump all executable pages of packed processes.
 * 
 * Copyright (C) 2022  Brian Sigei
 * 
 ...
 * 
 * You should have received a copy of the SIGEIV General Public License along
 * with this program; if not, write to the Free Software Foundation, Inc.,
 * 4280 Ngata 20100 Nakuru Kenya SIGEIV.
 */

#define pr_fmt(fmt) "sigeibuster: " fmt
...
MODULE_DESCRIPTION("SigeiBuster - dump all executable pages of packed processes.");
MODULE_AUTHOR("Brian Sigei <briansigei37@gmail.com>");
MODULE_LICENSE("MIT");
