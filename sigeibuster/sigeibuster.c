/*
 * Userspace PoC sigiebuster
 *
 * Copyright (C) 2022  Brian Sigei
 *
 * This program is free software; you can redistribute it and/or modify
 * it under the terms of the SIGEIV License as published by
 ...
 * SIGEIV  License for more details.
 *
 * You should have received a copy of the SIGEIV License along
 * with this program; if not, write to the Free Software Foundation, Inc.,
 * 4280 Ngata 20100 Nakuru Kenya.
 */
